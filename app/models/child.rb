class Child < ApplicationRecord
  ...
  validates :first_name, :last_name, :age, :grade, :food_allergies, :special_medical_needs, :emergency_contact, presence: true

  validates :age, numericality: { only_integer: true, greater_than_or_equal_to: 0, message: "must be a positive integer" }

  VALID_GRADES = %w(Nur K 1st 2nd 3rd 4th 5th 6th 1 2 3 4 5 6)
  validates :grade, inclusion: { in: VALID_GRADES, message: "%{value} is not a valid grade" }
